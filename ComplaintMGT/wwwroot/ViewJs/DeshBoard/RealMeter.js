var EchartsColumnsBasicLightFeletr2 = function () {
    ...
    var _columnsBasicLightExample = function () {
        ...
        if (columns_basic_element) {
            ...
            var selected = $("input[type='radio'][name='when_posted']:checked").val();
            var Menu = $("input[type='radio'][name='when_menu']:checked").val();
            var test = new Array();
            var subMenu = '';
            var SubRedioMenu = '';
            if (Menu == 'ASSETS') {
                $('.cek-Assets:checked').each(function () {
                    test.push($(this).val());
                });
                subMenu = test.toString();
            }
            else if (Menu == 'Ops') {
                $('.ops-check:checked').each(function () {
                    test.push($(this).val());
                });
                subMenu = test.toString();
                SubRedioMenu = $("input[type='radio'][name='when_OPS_WINDOW_menu']:checked").val();
            }
            ...
            $.ajax({
                ...
                data: { type: selected, Menu: Menu, subMenu: subMenu, SubRedioMenu: SubRedioMenu },
                //  dataType: "json",
...
$("#Filter").click(function () {
    EchartsColumnsBasicLightFeletr2.init();
});