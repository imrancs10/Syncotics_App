...
$('#ddlSite').change(function () {
    ...
    $.ajax({
        ...
        data: { SiteId: ddlsource, DeviceType: '5,8' },
        success: function (Mydata) {
            var data = JSON.parse(Mydata);
            $("#ddlAsset").empty();
...
function GetFile(FType) {
    ...
    $.ajax({
        type: "POST",
        url: "/Report/ExportGeKitchenData",
        data: { FromDate: Fromdate, Todate: Todate, DeviceId: DeviceId, FType: FType, FName: FName, DeviceType: '5,8'},
        xhrFields: {
