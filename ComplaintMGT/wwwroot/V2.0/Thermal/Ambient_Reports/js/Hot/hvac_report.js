...
var RenderTable = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/GetHotAmbientTemperatureSeries?assetid=" + assetid,
                data: {},
                success: function (data) {
...
var RenderTable2 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/ConsolidatedAmbientTemperatureHot",
                data: {},
                success: function (data) {
...
var RenderTable3 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/GetHotAmbientTemperatureHrlyAVGSeries?assetid=" + assetid,
                data: {},
                success: function (data) {
                    var JSONObj = JSON.parse(data);
...
var RenderTable4 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/AmbientTemperatureHeatMapHot?assetid=" + assetid,
                data: {},
                success: function (data) {
