...
var RenderTable = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/GetColdAmbientTemperatureSeries?assetid=" + assetid,
                data: {},
                success: function (data) {
...
var RenderTable2 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/ConsolidatedAmbientTemperatureCold",
                data: {},
                success: function (data) {
...
var RenderTable3 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/GetColdAmbientTemperatureSeries_HrlyAvg?assetid=" + assetid,
                data: {},
                success: function (data) {
                    var JSONObj = JSON.parse(data);
...
var RenderTable4 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/AmbientTemperatureHeatMapCold?assetid=" + assetid,
                data: {},
                success: function (data) {
