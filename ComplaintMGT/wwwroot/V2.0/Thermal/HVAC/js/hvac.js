...
var HVACAlertDashboard = function () {
    var _echartsAlertChartDashboard = function (duration = 0) {
        ...
        var alertChart = echarts.init(document.getElementById('hvac-chart-container-alert'),
            null, {
            renderer: 'canvas',
            useDirtyRect: false
        });
        ...
        $.ajax({
            type: "post",
            url: "/Thermal/HVACDeshAlerts?days=" + duration,
            data: {},
...
var HVACComplianceDashboard = function () {
    ...
    var _echartHVACDashboardInit = function (duration = 0) {
        var complianceDetailChart = echarts.init(document.getElementById('hvac-compliance-chart-container'),
            null, {
            renderer: 'canvas',
            useDirtyRect: false
        });
        ...
        $.ajax({
            type: "post",
            url: "/Thermal/HVACCompliance?days=" + duration,
            data: {},
            success: function (data) {
...
var HVACThermalMonitoringDashboard = function () {
    var _thermalMonitoringTable = function (duration =0) {
        ...
        $.ajax({
            type: "post",
            url: "/Thermal/HVACThermalMonitoring?days=" + duration,
            data: {},
            success: function (data) {
                var myJSON = JSON.parse(data);
...
var HVACOpsDashboard = function () {
    var _opsDash = function (duration = 0) {
        ...
        $.ajax({
            type: "post",
            url: "/Thermal/HVACThermalMonitoringOps?days=" + duration,
            data: {},
            success: function (data) {
...
var HVACSeriesData = function () {
    var _seriesData = function (duration = 0) {
        ...
        $.ajax({
            type: "post",
            url: "/Thermal/HVACThermalMonitoringSeries?days=" + duration,
            data: {},
            success: function (data) {
                let option8;
                var myJSON = JSON.parse(data);
