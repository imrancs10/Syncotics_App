...
var HVACSeriesDataWarmByAssetId = function (assetid) {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/GetWarmThermalMonitoringSeries?assetid=" + assetid,
        data: {},
            ...
            success: function (data) {
                ...
                for (let i = 0; i < assetLis.length; i++) {
                    ...
                    if (i == 0) {
                        ...
                        HVACSeriesDataWarmByAssetId(assetLis[i].AssetId);
...
var _echartsThermalMonitoring2ChartDashboard = function () {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/ConsolidatedThermalMonitoringWarm",
        data: {},
        success: function (data) {
...
var _echartsThermalProfileChartDashboard = function (assetid) {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/ThermalMonitoringHeatMapWarm?assetid=" + assetid,
        data: {},
