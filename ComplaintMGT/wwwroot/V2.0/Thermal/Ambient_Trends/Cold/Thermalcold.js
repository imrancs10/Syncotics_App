...
var ambientSeriesDataColdByAssetId = function (assetid) {
    var dom8 = document.getElementById('thermalMonitoringwithPeakTemperature_cold');
    //dom8.innerHTML = '';
    console.log(assetid);
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/GetAmbientTempColdThermalMonitoringSeries?assetid=" + assetid,
        data: {},
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let i = 0; i < assetLis.length; i++) {
                    ...
                    if (i == 0) {
                        ambientSeriesDataColdByAssetId(assetLis[i].AssetId)
...
var _echartsThermalMonitoring2ChartDashboard = function () {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/AmbientConsolidatedThermalMonitoringCold",
        data: {},
        success: function (data) {
...
var _echartsThermalProfileChartDashboard = function (assetid) {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/AmbientThermalMonitoringHeatMapCold?assetid=" + assetid,
        data: {},
