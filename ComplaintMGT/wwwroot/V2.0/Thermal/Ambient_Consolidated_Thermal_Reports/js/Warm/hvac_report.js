...
var RenderTable = function (assetid) {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/GetWarmAmbientTemperatureSeries?assetid=" + assetid,
        data: {},
        success: function (data) {
            ...
            if (JSONObj != null && JSONObj.length > 0) {
                ...
                arrObj.forEach((o, i) => {
                    ...
                    transactionDateCol.innerText = formatAMPM(new Date(o.LogTime));//.replace("T", " ");// o.LogTime.split('T')[0];
...
var RenderTable2 = function (assetid) {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/ConsolidatedAmbientTemperatureWarm",
        data: {},
        success: function (data) {
...
var RenderTable3 = function (assetid) {
    ...
    $.ajax({
        type: "post",
        url: "/Thermal/GetWarmAmbientTemperatureSeriesHrlyAvg?assetid=" + assetid,
        data: {},
        success: function (data) {
            var JSONObj = JSON.parse(data);
...
var RenderTable4 = function (assetid) {
    $.ajax({
        type: "post",
        url: "/Thermal/AmbientTemperatureHeatMapWarm?assetid=" + assetid,
        data: {},
        success: function (data) {
