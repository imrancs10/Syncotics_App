...
var RenderTable = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/GetWarmAmbientHumiditySeries?assetid=" + assetid,
                data: {},
                success: function (data) {
...
var RenderTable2 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/ConsolidatedAmbientHumidityWarm",
                data: {},
                success: function (data) {
...
var RenderTable3 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/GetWarmAmbientHumiditySeriesHrlyAvg?assetid=" + assetid,
                data: {},
                success: function (data) {
                    var JSONObj = JSON.parse(data);
...
var RenderTable4 = function (assetid) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.ajax({
                type: "post",
                url: "/Thermal/AmbientHumidityHeatMapWarm?assetid=" + assetid,
                data: {},
                success: function (data) {
